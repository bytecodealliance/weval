...
pub(crate) struct Intrinsics {
    ...
    pub exit_path: Option<Func>,
    pub stop_exit_path: Option<Func>,
...
impl Intrinsics {
    pub(crate) fn find(module: &Module) -> Intrinsics {
        Intrinsics {
            ...
            exit_path: find_imported_intrinsic(module, "exit.path", &[], &[]),
            stop_exit_path: find_imported_intrinsic(module, "stop.exit.path", &[], &[]),
